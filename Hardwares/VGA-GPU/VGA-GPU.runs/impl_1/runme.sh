...
HD_PWD='D:/CelestiCall/Hardwares/VGA-GPU/VGA-GPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_GPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RGB_GPU.tcl -notrace
