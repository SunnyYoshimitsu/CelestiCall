...
HD_PWD='D:/CelestiCall/Hardwares/VGA-GPU/VGA-GPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_GPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGB_GPU.tcl
