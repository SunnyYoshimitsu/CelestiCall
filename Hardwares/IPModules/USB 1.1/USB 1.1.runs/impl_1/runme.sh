...
HD_PWD='D:/CelestiCall/Hardwares/IPModules/USB 1.1/USB 1.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log usbh_host.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source usbh_host.tcl -notrace
