...
HD_PWD='D:/CelestiCall/Hardwares/IPModules/Sound/Sound Processor/Sound Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsm_test_with_inmp441.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dsm_test_with_inmp441.tcl -notrace
