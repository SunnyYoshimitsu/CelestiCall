...
HD_PWD='D:/CelestiCall/Hardwares/IPModules/Sound/Sound Processor/Sound Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsm_test_with_inmp441.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsm_test_with_inmp441.tcl
