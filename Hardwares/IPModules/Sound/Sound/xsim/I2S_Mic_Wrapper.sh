...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L fifo_generator_v13_2_9 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot I2S_Mic_Wrapper xil_defaultlib.I2S_Mic_Wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim I2S_Mic_Wrapper -key {Behavioral:sim_1:Functional:I2S_Mic_Wrapper} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm fifo_generator_v13_2_9)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb I2S_Mic_Wrapper.wdb xsim.dir libdpi.so)
