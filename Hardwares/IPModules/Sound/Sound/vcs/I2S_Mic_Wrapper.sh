...
#
# Script generated by Vivado on Thu Jan 09 14:43:12 -0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : I2S_Mic_Wrapper.sh
...
#
# Usage        : I2S_Mic_Wrapper.sh
#                I2S_Mic_Wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                I2S_Mic_Wrapper.sh [-reset_run]
#                I2S_Mic_Wrapper.sh [-reset_log]
#                I2S_Mic_Wrapper.sh [-help]
#
...
#                script (type 'I2S_Mic_Wrapper.sh -help' for more information).
#
...
# script info
echo -e "I2S_Mic_Wrapper.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./I2S_Mic_Wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../ Processor/Sound/ Processor.srcs/sources_1/new/Sound_Output.sv" \
  "../ Processor/Sound/ Processor.srcs/sources_1/new/dsm_module.sv" \
  "../ Processor/Sound/ Processor.srcs/sources_1/new/verilog_shift_register_test_PISO.sv" \
  "../ Processor/Sound/ Processor.srcs/sources_1/new/I2S_Mic_Wrapper.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.I2S_Mic_Wrapper xil_defaultlib.glbl -o I2S_Mic_Wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./I2S_Mic_Wrapper_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key I2S_Mic_Wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc I2S_Mic_Wrapper_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./I2S_Mic_Wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: I2S_Mic_Wrapper.sh [-help]\n\
Usage: I2S_Mic_Wrapper.sh [-step]\n\
Usage: I2S_Mic_Wrapper.sh [-lib_map_path]\n\
Usage: I2S_Mic_Wrapper.sh [-reset_run]\n\
Usage: I2S_Mic_Wrapper.sh [-reset_log]\n\
Usage: I2S_Mic_Wrapper.sh [-keep_index]\n\
Usage: I2S_Mic_Wrapper.sh [-noclean_files]\n\n\
