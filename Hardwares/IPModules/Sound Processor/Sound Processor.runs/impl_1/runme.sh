...
HD_PWD='D:/CelestiCall/Hardwares/IPModules/Sound Processor/Sound Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2S_Mic_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2S_Mic_Wrapper.tcl -notrace
