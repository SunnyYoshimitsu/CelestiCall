...
HD_PWD='D:/CelestiCall/Hardwares/IPModules/Proto_Star/Proto_Star.runs/CPU_system_v_tc_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_system_v_tc_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_system_v_tc_0_2.tcl
