...
HD_PWD='D:/CelestiCall/Hardwares/IPModules/USB 1.1/USB 1.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usbh_host.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usbh_host.tcl
